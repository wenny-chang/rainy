...
L.Control.IDWLogo = L.Control.extend({
    initialize: function (options) {
        options['latest-updated-time'] =
            typeof options['latest-updated-time'] !== 'undefined' ? options['latest-updated-time'] : new Date();
    ...
    onAdd: function (map) {
        ...
        div.innerHTML = `<div class="leaflet-control-layers-base">
        <table>
          <thead>
            <tr>
    ...
    ifMobile: function () {
        ...
        )[0].innerHTML += ` | <a target="_blank" rel="noopener noreferrer" style="text-decoration: none" href="https://www.iis.sinica.edu.tw/index_zh.html">IIS AS</a>
